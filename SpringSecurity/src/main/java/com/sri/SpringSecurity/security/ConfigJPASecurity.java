 ...
 * @EnableWebSecurity
 * 
 * @Configuration public class ConfigJPASecurity extends
 ...
 * http.authorizeRequests().antMatchers("/hi", "/admin").hasRole("ADMIN") //
 * most restrictive .antMatchers("/hi", "/user").hasRole("USER") // less
 * restrictive .antMatchers("/").permitAll().and().formLogin(); }
 * 
 * }
 */